...
import { decreaseBill, decreaseCartItems, increaseBill, increaseCartItems, emptyCart } from '../Redux/productsSlice'

function Details() {
    const dispatch = useDispatch()

    const state = useSelector(state => state.products)
    const { product, totalBill } = state
                    ...
                    <div className='details'>
                        ...
                        <div className='shoe'>
                            ...
                            <button 
                                className='plus'
                                onClick={() => {
                                    dispatch(increaseCartItems(product.id))
                                    dispatch(increaseBill(product.marketPrice))
                                }}
                            >
                            ...
                            <button
                                className='minus'
                                onClick={() => {
                                    dispatch(decreaseCartItems(product.id))
                                    dispatch(decreaseBill(product.marketPrice))
                                }}
